---
heading: Chapter 5
title: "General and Personal Inclinations"
weight: 14
writer:
  name: Aristotle
  url: https://en.wikipedia.org/wiki/Aristotle
c: "indigo"
description: "There are 2 kinds of things naturally pleasant"
icon: "Aristotle"
---


There are 2 kinds of things naturally pleasant:

1. Those which are pleasant generally
2. Those which are so relatively to particular kinds of animals and men

{{< n n="This is from the difference of the Soul and Oversoul" >}}


So there are others which are not naturally pleasant but which come to be so in consequence either of maimings, or custom, or depraved natural tastes: and one may observe moral states similar to those we have been speaking of, having respectively these classes of things for their object-matter.
