...
If a thing exists forever, out of that of which it consists it would necessarily also, if it had come into being, have come into being, and since everything comes to be what it comes to be out of that which is it potentially (for it could not have come to be out of that which had not this capacity, nor could it consist of such elements), and since the potential can be either actual or not.

This being so, however everlasting number or anything else that has matter is, it must be capable of not existing.

This is just as that which is any number of years old is as capable of not existing as that which is a day old.
...
<!-- If this is true universally-that no substance is eternal unless it is actuality. -->

This is true universally: an eternal substance must have actuality.

The elements are matter that underlies substance.

No eternal substance can have elements present in it, of which it consists.

Some people describe the element which acts with the One as an indefinite dyad.

They object to 'the unequal' because of the ensuing difficulties.
...
They thought that all things that exist would be one (as Being itself).
...
Sometimes it means substance. Sometimes it is of a certain quality. Sometimes it is of a certain quantity. Sometimes, it is other categories.

What sort of 'one', then, are all the things that are, if non-being is to be supposed not to be? 
...
2. Of what sort of non-being and being do the things that are consist? 

'Nonbeing' also has many senses.

<!-- 'Being a man' and  -->

'Not being a man' means not being a certain substance.

'Not being straight' means not being of a certain quality.

'Not being three cubits long' means not being of a certain quantity.
...
For all 'number' means a quantity, and so does the 'unit', unless it means a measure or the quantitatively indivisible. If, then, the quantitative and the 'what' are different, we are not told whence or how the 'what' is many; but if any one says they are the same, he has to face many inconsistencies.
