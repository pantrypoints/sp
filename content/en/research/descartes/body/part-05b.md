...
From the beginning, its ventricles take very irregular shapes.

This isbecause the blood particles that they contain are unequal.
- They took different paths in expanding

As a result, they made holes in the parts of the seed that they compressed.

All of these holes gradually widened to make a single ventricle.
...
The blood:
- descends into the heart through these 2 entrances.
- stretches these 2 as it returns, causing them to expand. 

The other blood that follows it through these same entrances prevents it returning through the same path. 

<!-- via these. -->

This is why its particles spread all around the seed that makes up the heart and makes a number of small holes there.
...
The 2 actions of the blood are:
- falling into the heart through these entrances
- leaving the heart via neighbouring ones

 <!-- one sees that, following the rules of mechanics,  -->

The fibres of the heart are between these 2 actions.
- These fibres spread out as flaps of skin and taken the shape that these valvules have.

But those at the entrances of the pulmonary artery and the aorta:
- are outside the heart
- are not produced in the same way
- only make up the skin of the arteries

The arteries has been folded and moved along from the inside by:
- the action of the blood leaving the heart
- the resistance of the blood already in these arteries which withdraws towards their circumference, finally passing through it.
...
- the intestines where the excrement already collected resists the flow of the excrement coming down.
- the passages of the gall
- in the veins more evidently where the weight of the blood that carries it to the extremities of the legs, arms, and other parts, often resists its ordinary course, which carries it from these extremities to the heart. 

This is why the spirits also form valvules in:
- the nerves
- the entries and exits of these muscles

This is even though their small size prevents them from being observed by our senses.


## What does the heat of the heart consists in? How is its movement produced?

The heart beats throughout its life. 

All its fibres are made so flexible by this movement that this flexibility could easily be returned to them by an external force after it is cold and dead. 

Yet the heart remains rigid after death, in the shape that it had previously in systole (between 2 of its beats) without it being easy to give it back the shape it had in diastole (the time when it beats against the chest).

This is because this diastole movement was from the start caused by **heat from the action of fire-aether driving out the air-aether from around some parts of the seed, having communicated its agitation to them.** 
...
## What causes the shape of the heart?

These are easy to deduce from the way the heart is formed.

1. There is a difference between the 2 ventricles.

- This clearly shows that they have been formed at different times.
- This is why the left ventricle is much longer and more pointed than the right.

2. The flesh covering this left ventricle is very much thicker at the sides of the heart than at its point.

This is because the action of the blood which expands in this ventricle spreads out all around. 

This strikes the sides with more force than at the point, because they are closer to its centre and are opposite one another.
