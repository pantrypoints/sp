...
Vortex numbers excel in geometries. This is because Cartesian Physics emphasizes particle shapes instead of the paths that the particles take i.e. the paths are the results of the shapes. So there is no need to burden oneself with tensors and differential geometry. 
